        ...
        <div class='row'>
            ...
            <div class='col-md-7'>
                ...
                <div class='content-header'> 
                    Signup <small>Create a new doctor account</small>
                </div>
                    ...
                    <div class='form-holder'> 
                        ...
                        if(isset($_POST['fn'])){
                            ...
                            if($password !== $confirmPassword){
                                ...
                                if(Doctor::register($firstName, $secondName, $email, $phone, $password)){
                        ...
                        $form->textBox("Confirm Password", "confirm-password", "password", "", "");
                        $form->close("Signup"); 
                        ?> 
                    </div> 
