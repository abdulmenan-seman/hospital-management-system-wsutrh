            ...
            <div class='col-md-7'>
                <div class='content-area'> 
                    <div class='content-header'> 
                        Signup Doctor <small>Register a new doctor</small>
                    </div>
                    <div class='content-body'> 
                        <div class='form-holder'> 
                            ...
                            if(isset($_POST['fn'])){
                                ...
                                $role = $_POST['role'];
                                $gender = $_POST['gender'];
                                $password = "hospital"; // Default password

                                // Call a method to register the doctor
                                if(Doctor::register($firstName, $secondName, $email, $phone, $role, $gender, $password)){
                                    Messages::success("Doctor registered successfully!");
                                    Config::redir("doctors-record.php");
                                } else {
